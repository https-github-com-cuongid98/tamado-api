...
var s3Upload_1 = __importDefault(require("$middlewares/s3Upload"));
var AuthController = /** @class */ (function () {
    function AuthController() {
    }
    AuthController.prototype.upload = function (req) {
    ...
    __decorate([
        decorator_1.Post("/upload", [s3Upload_1.default.upload.array("files", 3)]),
