...
(function (ErrorCode) {
    ...
    ErrorCode[ErrorCode["Phone_Existed"] = 16] = "Phone_Existed";
    ErrorCode[ErrorCode["Phone_Not_Exist"] = 17] = "Phone_Not_Exist";
    ...
    ErrorCode[ErrorCode["Conversation_Not_Exist"] = 23] = "Conversation_Not_Exist";
    ErrorCode[ErrorCode["You_Not_Member_In_This_Conversation"] = 24] = "You_Not_Member_In_This_Conversation";
...
(function (ErrorMessage) {
    ...
    ErrorMessage[ErrorMessage["Verified_Code_Max_Try"] = 20] = "Verified_Code_Max_Try";
    ErrorMessage[ErrorMessage["You_Can_Not_Follow_Yourself"] = 21] = "You_Can_Not_Follow_Yourself";
    ErrorMessage[ErrorMessage["Blocked"] = 22] = "Blocked";
    ErrorMessage[ErrorMessage["Conversation_Not_Exist"] = 23] = "Conversation_Not_Exist";
    ErrorMessage[ErrorMessage["You_Not_Member_In_This_Conversation"] = 24] = "You_Not_Member_In_This_Conversation";
...
(function (EventSocket) {
    EventSocket["CONVERSATIONS"] = "conversations";
    EventSocket["MESSAGES"] = "messages";
    EventSocket["READ_MESSAGE"] = "read_message";
    EventSocket["CREATE_ROOM"] = "create_room";
    EventSocket["JOIN_ROOM"] = "join_room";
    EventSocket["LEAVE_ROOM"] = "leave_room";
    EventSocket["VIDEO_CALL"] = "video_call";
    EventSocket["START_TYPING"] = "start_typing";
    EventSocket["END_TYPING"] = "end_typing";
    EventSocket["TYPING"] = "typing";
    EventSocket["OFF_TYPING"] = "off_typing";
})(EventSocket = exports.EventSocket || (exports.EventSocket = {}));
var MemberType;
(function (MemberType) {
    MemberType[MemberType["APP"] = 1] = "APP";
    MemberType[MemberType["CMS"] = 2] = "CMS";
})(MemberType = exports.MemberType || (exports.MemberType = {}));
var RedirectType;
(function (RedirectType) {
    RedirectType[RedirectType["HOME"] = 1] = "HOME";
    RedirectType[RedirectType["MEMBER"] = 2] = "MEMBER";
